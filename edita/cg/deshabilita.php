...
<div class="col-md-12 " id="deshabilita" style="display: none">
    <div class="portlet box  blue-sharp">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-car"></i>Desabilita cargador <strong><?php  echo $_GET['id'] ?> </strong>
            </div>
            <div class="tools">
        ...
        <div class="col-xs-12 ">
            <div class="form-group"><br><br><br>
                ...
                <div class="col-md-9">
                    <select class="otro" id="formaDeshabilita">
                ...
                <div class="btn-group btn-group btn-group-justified">
                    <div class="col-s-12 ">
                        <a href="javascript:deshabilitaEnvia('<?php  echo $_GET['id'] ?>')" class="btn red btn-block" style="height: 110px;"><h2> <i class="fa fa-send"></i></h2><h5>Deshabilitar Cargador</h5></a>
                    </div>
                    <div class="col-s-12 ">
