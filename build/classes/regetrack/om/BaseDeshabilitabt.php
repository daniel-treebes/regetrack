...
/**
 * Base class that represents a row from the 'deshabilitabt' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseDeshabilitabt extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DeshabilitabtPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DeshabilitabtPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DeshabilitabtPeer::ID;
        }
    ...
    public function setMotivo($v)
    {
        ...
        if ($this->motivo !== $v) {
            $this->motivo = $v;
            $this->modifiedColumns[] = DeshabilitabtPeer::MOTIVO;
        }
    ...
    public function setFechaEntrada($v)
    {
        ...
        if ($this->fecha_entrada !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeshabilitabtPeer::FECHA_ENTRADA;
            }
    ...
    public function setFechaSalida($v)
    {
        ...
        if ($this->fecha_salida !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeshabilitabtPeer::FECHA_SALIDA;
            }
        } // if either are not null
    ...
    public function setUsuarioEntrada($v)
    {
        ...
        if ($this->usuario_entrada !== $v) {
            ...
            $this->modifiedColumns[] = DeshabilitabtPeer::USUARIO_ENTRADA;
        }
    ...
    public function setUsuarioSalida($v)
    {
        ...
        if ($this->usuario_salida !== $v) {
            ...
            $this->modifiedColumns[] = DeshabilitabtPeer::USUARIO_SALIDA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bt = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 7; // 7 = DeshabilitabtPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Deshabilitabt object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DeshabilitabtPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DeshabilitabtQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DeshabilitabtPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DeshabilitabtPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DeshabilitabtPeer::BT)) {
            $modifiedColumns[':p' . $index++]  = '`bt`';
        }
        if ($this->isColumnModified(DeshabilitabtPeer::MOTIVO)) {
            $modifiedColumns[':p' . $index++]  = '`motivo`';
        }
        if ($this->isColumnModified(DeshabilitabtPeer::FECHA_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_entrada`';
        }
        if ($this->isColumnModified(DeshabilitabtPeer::FECHA_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_salida`';
        }
        if ($this->isColumnModified(DeshabilitabtPeer::USUARIO_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_entrada`';
        }
        if ($this->isColumnModified(DeshabilitabtPeer::USUARIO_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_salida`';
        }

        $sql = sprintf(
            'INSERT INTO `deshabilitabt` (%s) VALUES (%s)',
    ...
    {
        $pos = DeshabilitabtPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Deshabilitabt'][$this->getPrimaryKey()] = true;
        $keys = DeshabilitabtPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getBt(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBt($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DeshabilitabtPeer::ID)) $criteria->add(DeshabilitabtPeer::ID, $this->id);
        if ($this->isColumnModified(DeshabilitabtPeer::BT)) $criteria->add(DeshabilitabtPeer::BT, $this->bt);
        if ($this->isColumnModified(DeshabilitabtPeer::MOTIVO)) $criteria->add(DeshabilitabtPeer::MOTIVO, $this->motivo);
        if ($this->isColumnModified(DeshabilitabtPeer::FECHA_ENTRADA)) $criteria->add(DeshabilitabtPeer::FECHA_ENTRADA, $this->fecha_entrada);
        if ($this->isColumnModified(DeshabilitabtPeer::FECHA_SALIDA)) $criteria->add(DeshabilitabtPeer::FECHA_SALIDA, $this->fecha_salida);
        if ($this->isColumnModified(DeshabilitabtPeer::USUARIO_ENTRADA)) $criteria->add(DeshabilitabtPeer::USUARIO_ENTRADA, $this->usuario_entrada);
        if ($this->isColumnModified(DeshabilitabtPeer::USUARIO_SALIDA)) $criteria->add(DeshabilitabtPeer::USUARIO_SALIDA, $this->usuario_salida);
    ...
    {
        $criteria = new Criteria(DeshabilitabtPeer::DATABASE_NAME);
        $criteria->add(DeshabilitabtPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Deshabilitabt (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Deshabilitabt Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DeshabilitabtPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DeshabilitabtPeer();
        }
    ...
    {
        return (string) $this->exportTo(DeshabilitabtPeer::DEFAULT_STRING_FORMAT);
    }
