...
abstract class BaseSucursal extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the sucursal_suscripcioninicio field.
     * @var        int
     */
    protected $sucursal_suscripcioninicio;

    /**
     * The value for the sucursal_suscripcionfin field.
     * @var        int
     */
    protected $sucursal_suscripcionfin;
    ...
    /**
     * @var        PropelObjectCollection|UcUsers[] Collection to store aggregation of UcUsers objects.
     */
    protected $collUcUserss;
    protected $collUcUserssPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $ucUserssScheduledForDeletion = null;
    ...
    /**
     * Get the [sucursal_suscripcioninicio] column value.
     *
     * @return int
     */
    public function getSucursalSuscripcioninicio()
    {

        return $this->sucursal_suscripcioninicio;
    }

    /**
     * Get the [sucursal_suscripcionfin] column value.
     *
     * @return int
     */
    public function getSucursalSuscripcionfin()
    {

        return $this->sucursal_suscripcionfin;
    }
    ...
    /**
     * Set the value of [sucursal_suscripcioninicio] column.
     *
     * @param  int $v new value
     * @return Sucursal The current object (for fluent API support)
     */
    public function setSucursalSuscripcioninicio($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->sucursal_suscripcioninicio !== $v) {
            $this->sucursal_suscripcioninicio = $v;
            $this->modifiedColumns[] = SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO;
        }


        return $this;
    } // setSucursalSuscripcioninicio()

    /**
     * Set the value of [sucursal_suscripcionfin] column.
     *
     * @param  int $v new value
     * @return Sucursal The current object (for fluent API support)
     */
    public function setSucursalSuscripcionfin($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->sucursal_suscripcionfin !== $v) {
            $this->sucursal_suscripcionfin = $v;
            $this->modifiedColumns[] = SucursalPeer::SUCURSAL_SUSCRIPCIONFIN;
        }


        return $this;
    } // setSucursalSuscripcionfin()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->sucursal_suscripcioninicio = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->sucursal_suscripcionfin = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->resetModified();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->ucUserssScheduledForDeletion !== null) {
                if (!$this->ucUserssScheduledForDeletion->isEmpty()) {
                    UcUsersQuery::create()
                        ->filterByPrimaryKeys($this->ucUserssScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->ucUserssScheduledForDeletion = null;
                }
            }

            if ($this->collUcUserss !== null) {
                foreach ($this->collUcUserss as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO)) {
            $modifiedColumns[':p' . $index++]  = '`sucursal_suscripcioninicio`';
        }
        if ($this->isColumnModified(SucursalPeer::SUCURSAL_SUSCRIPCIONFIN)) {
            $modifiedColumns[':p' . $index++]  = '`sucursal_suscripcionfin`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`sucursal_nombre`':
                        ...
                        break;
                    case '`sucursal_suscripcioninicio`':
                        $stmt->bindValue($identifier, $this->sucursal_suscripcioninicio, PDO::PARAM_INT);
                        break;
                    case '`sucursal_suscripcionfin`':
                        $stmt->bindValue($identifier, $this->sucursal_suscripcionfin, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getSucursalSuscripcioninicio();
                break;
            case 4:
                return $this->getSucursalSuscripcionfin();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getSucursalSuscripcioninicio(),
            $keys[4] => $this->getSucursalSuscripcionfin(),
        );
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collUcUserss) {
                $result['UcUserss'] = $this->collUcUserss->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setSucursalSuscripcioninicio($value);
                break;
            case 4:
                $this->setSucursalSuscripcionfin($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setSucursalSuscripcioninicio($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setSucursalSuscripcionfin($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO)) $criteria->add(SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO, $this->sucursal_suscripcioninicio);
        if ($this->isColumnModified(SucursalPeer::SUCURSAL_SUSCRIPCIONFIN)) $criteria->add(SucursalPeer::SUCURSAL_SUSCRIPCIONFIN, $this->sucursal_suscripcionfin);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSucursalSuscripcioninicio($this->getSucursalSuscripcioninicio());
        $copyObj->setSucursalSuscripcionfin($this->getSucursalSuscripcionfin());
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getUcUserss() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addUcUsers($relObj->copy($deepCopy));
                }
            }
    ...
    public function setBateriass(PropelCollection $bateriass, PropelPDO $con = null)
    {
        ...
        foreach ($bateriassToDelete as $bateriasRemoved) {
            $bateriasRemoved->setSucursal(null);
        }
    ...
    public function setCargadoress(PropelCollection $cargadoress, PropelPDO $con = null)
    {
        ...
        foreach ($cargadoressToDelete as $cargadoresRemoved) {
            $cargadoresRemoved->setSucursal(null);
        }
    ...
    public function setMontacargass(PropelCollection $montacargass, PropelPDO $con = null)
    {
        ...
        foreach ($montacargassToDelete as $montacargasRemoved) {
            $montacargasRemoved->setSucursal(null);
        }
    ...
    /**
     * Clears out the collUcUserss collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     ...
     * @see        addUcUserss()
     */
    public function clearUcUserss()
    {
        $this->collUcUserss = null; // important to set this to null since that means it is uninitialized
        $this->collUcUserssPartial = null;

        return $this;
    }

    /**
     * reset is the collUcUserss collection loaded partially
     *
     * @return void
     */
    public function resetPartialUcUserss($v = true)
    {
        $this->collUcUserssPartial = $v;
    }

    /**
     * Initializes the collUcUserss collection.
     *
     * By default this just sets the collUcUserss collection to an empty array (like clearcollUcUserss());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initUcUserss($overrideExisting = true)
    {
        if (null !== $this->collUcUserss && !$overrideExisting) {
            return;
        }
        $this->collUcUserss = new PropelObjectCollection();
        $this->collUcUserss->setModel('UcUsers');
    }

    /**
     * Gets an array of UcUsers objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|UcUsers[] List of UcUsers objects
     * @throws PropelException
     */
    public function getUcUserss($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collUcUserssPartial && !$this->isNew();
        if (null === $this->collUcUserss || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collUcUserss) {
                // return empty collection
                $this->initUcUserss();
            } else {
                $collUcUserss = UcUsersQuery::create(null, $criteria)
                    ->filterBySucursal($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collUcUserssPartial && count($collUcUserss)) {
                      $this->initUcUserss(false);

                      foreach ($collUcUserss as $obj) {
                        if (false == $this->collUcUserss->contains($obj)) {
                          $this->collUcUserss->append($obj);
                        }
                      }

                      $this->collUcUserssPartial = true;
                    }

                    $collUcUserss->getInternalIterator()->rewind();

                    return $collUcUserss;
                }

                if ($partial && $this->collUcUserss) {
                    foreach ($this->collUcUserss as $obj) {
                        if ($obj->isNew()) {
                            $collUcUserss[] = $obj;
                        }
                    }
                ...
                $this->collUcUserss = $collUcUserss;
                $this->collUcUserssPartial = false;
            }
        }

        return $this->collUcUserss;
    }

    /**
     * Sets a collection of UcUsers objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $ucUserss A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Sucursal The current object (for fluent API support)
     */
    public function setUcUserss(PropelCollection $ucUserss, PropelPDO $con = null)
    {
        $ucUserssToDelete = $this->getUcUserss(new Criteria(), $con)->diff($ucUserss);


        $this->ucUserssScheduledForDeletion = $ucUserssToDelete;

        foreach ($ucUserssToDelete as $ucUsersRemoved) {
            $ucUsersRemoved->setSucursal(null);
        }

        $this->collUcUserss = null;
        foreach ($ucUserss as $ucUsers) {
            $this->addUcUsers($ucUsers);
        }

        $this->collUcUserss = $ucUserss;
        $this->collUcUserssPartial = false;
    ...
    /**
     * Returns the number of related UcUsers objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related UcUsers objects.
     * @throws PropelException
     */
    public function countUcUserss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collUcUserssPartial && !$this->isNew();
        if (null === $this->collUcUserss || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collUcUserss) {
            ...
            if ($partial && !$criteria) {
                return count($this->getUcUserss());
            }
            $query = UcUsersQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collUcUserss);
    }

    /**
     * Method called to associate a UcUsers object to this object
     * through the UcUsers foreign key attribute.
     *
     * @param    UcUsers $l UcUsers
     * @return Sucursal The current object (for fluent API support)
     */
    public function addUcUsers(UcUsers $l)
    {
        if ($this->collUcUserss === null) {
            $this->initUcUserss();
            $this->collUcUserssPartial = true;
        ...
        if (!in_array($l, $this->collUcUserss->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddUcUsers($l);

            if ($this->ucUserssScheduledForDeletion and $this->ucUserssScheduledForDeletion->contains($l)) {
                $this->ucUserssScheduledForDeletion->remove($this->ucUserssScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	UcUsers $ucUsers The ucUsers object to add.
     */
    protected function doAddUcUsers($ucUsers)
    {
        $this->collUcUserss[]= $ucUsers;
        $ucUsers->setSucursal($this);
    }

    /**
     * @param	UcUsers $ucUsers The ucUsers object to remove.
     * @return Sucursal The current object (for fluent API support)
     */
    public function removeUcUsers($ucUsers)
    {
        if ($this->getUcUserss()->contains($ucUsers)) {
            $this->collUcUserss->remove($this->collUcUserss->search($ucUsers));
            if (null === $this->ucUserssScheduledForDeletion) {
                $this->ucUserssScheduledForDeletion = clone $this->collUcUserss;
                $this->ucUserssScheduledForDeletion->clear();
            }
            $this->ucUserssScheduledForDeletion[]= $ucUsers;
            $ucUsers->setSucursal(null);
        }
    ...
    public function clear()
    {
        ...
        $this->sucursal_suscripcioninicio = null;
        $this->sucursal_suscripcionfin = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collUcUserss) {
                foreach ($this->collUcUserss as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collMontacargass = null;
        if ($this->collUcUserss instanceof PropelCollection) {
            $this->collUcUserss->clearIterator();
        }
        $this->collUcUserss = null;
        $this->aEmpresa = null;
    }
