...
/**
 * Base class that represents a row from the 'montacargas_baterias' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseMontacargasBaterias extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'MontacargasBateriasPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        MontacargasBateriasPeer
     */
    ...
    public function setIdmontacargas($v)
    {
        ...
        if ($this->idmontacargas !== $v) {
            ...
            $this->modifiedColumns[] = MontacargasBateriasPeer::IDMONTACARGAS;
        }
    ...
    public function setIdbaterias($v)
    {
        ...
        if ($this->idbaterias !== $v) {
            $this->idbaterias = $v;
            $this->modifiedColumns[] = MontacargasBateriasPeer::IDBATERIAS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = MontacargasBateriasPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating MontacargasBaterias object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MontacargasBateriasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MontacargasBateriasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MontacargasBateriasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MontacargasBateriasPeer::IDBATERIAS)) {
            $modifiedColumns[':p' . $index++]  = '`idbaterias`';
        }

        $sql = sprintf(
            'INSERT INTO `montacargas_baterias` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MontacargasBateriasPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MontacargasBateriasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['MontacargasBaterias'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of MontacargasBaterias (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return MontacargasBaterias Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return MontacargasBateriasPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new MontacargasBateriasPeer();
        }
    ...
    public function getBaterias(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBaterias === null && ($this->idbaterias !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBaterias->addMontacargasBateriass($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MontacargasBateriasPeer::DEFAULT_STRING_FORMAT);
    }
