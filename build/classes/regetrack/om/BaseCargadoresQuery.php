 ...
 *
 *
 * @method CargadoresQuery orderById($order = Criteria::ASC) Order by the id column
 * @method CargadoresQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 * @method CargadoresQuery orderByTipo($order = Criteria::ASC) Order by the tipo column
 *
 * @method CargadoresQuery groupById() Group by the id column
 * @method CargadoresQuery groupByNombre() Group by the nombre column
 * @method CargadoresQuery groupByTipo() Group by the tipo column
 *
 ...
 *
 * @method Cargadores findOneByNombre(string $nombre) Return the first Cargadores filtered by the nombre column
 * @method Cargadores findOneByTipo(int $tipo) Return the first Cargadores filtered by the tipo column
 *
 * @method array findById(int $id) Return Cargadores objects filtered by the id column
 * @method array findByNombre(string $nombre) Return Cargadores objects filtered by the nombre column
 * @method array findByTipo(int $tipo) Return Cargadores objects filtered by the tipo column
 *
...
abstract class BaseCargadoresQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `nombre`, `tipo` FROM `cargadores` WHERE `id` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CargadoresPeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CargadoresPeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(CargadoresPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(CargadoresPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CargadoresPeer::ID, $id, $comparison);
    }
    ...
    public function filterByNombre($nombre = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CargadoresPeer::NOMBRE, $nombre, $comparison);
    }
    ...
    public function filterByTipo($tipo = null, $comparison = null)
    {
        if (is_array($tipo)) {
            $useMinMax = false;
            if (isset($tipo['min'])) {
                $this->addUsingAlias(CargadoresPeer::TIPO, $tipo['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($tipo['max'])) {
                $this->addUsingAlias(CargadoresPeer::TIPO, $tipo['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CargadoresPeer::TIPO, $tipo, $comparison);
    }
    ...
    {
        if ($cargadores) {
            $this->addUsingAlias(CargadoresPeer::ID, $cargadores->getId(), Criteria::NOT_EQUAL);
        }
