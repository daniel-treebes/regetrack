...
/**
 * Base class that represents a row from the 'uso_baterias_montacargas' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseUsoBateriasMontacargas extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UsoBateriasMontacargasPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UsoBateriasMontacargasPeer
     */
     ...
     * @return UsoBateriasMontacargas The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UsoBateriasMontacargasPeer::ID;
        }
    ...
    public function setMc($v)
    {
        ...
        if ($this->mc !== $v) {
            $this->mc = $v;
            $this->modifiedColumns[] = UsoBateriasMontacargasPeer::MC;
        }
    ...
    public function setBt($v)
    {
        ...
        if ($this->bt !== $v) {
            $this->bt = $v;
            $this->modifiedColumns[] = UsoBateriasMontacargasPeer::BT;
        }
    ...
    public function setFechaEntrada($v)
    {
        ...
        if ($this->fecha_entrada !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UsoBateriasMontacargasPeer::FECHA_ENTRADA;
            }
    ...
    public function setFechaSalida($v)
    {
        ...
        if ($this->fecha_salida !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UsoBateriasMontacargasPeer::FECHA_SALIDA;
            }
        } // if either are not null
    ...
    public function setUsuarioEntrada($v)
    {
        ...
        if ($this->usuario_entrada !== $v) {
            ...
            $this->modifiedColumns[] = UsoBateriasMontacargasPeer::USUARIO_ENTRADA;
        }
    ...
    public function setUsuarioSalida($v)
    {
        ...
        if ($this->usuario_salida !== $v) {
            ...
            $this->modifiedColumns[] = UsoBateriasMontacargasPeer::USUARIO_SALIDA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->usuario_entrada = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->usuario_salida = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = UsoBateriasMontacargasPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UsoBateriasMontacargas object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aMontacargas !== null && $this->mc !== $this->aMontacargas->getIdmontacargas()) {
            $this->aMontacargas = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UsoBateriasMontacargasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UsoBateriasMontacargasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UsoBateriasMontacargasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::MC)) {
            $modifiedColumns[':p' . $index++]  = '`mc`';
        }
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::BT)) {
            $modifiedColumns[':p' . $index++]  = '`bt`';
        }
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::FECHA_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_entrada`';
        }
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::FECHA_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_salida`';
        }
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::USUARIO_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_entrada`';
        }
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::USUARIO_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_salida`';
        }

        $sql = sprintf(
            'INSERT INTO `uso_baterias_montacargas` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UsoBateriasMontacargasPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UsoBateriasMontacargasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UsoBateriasMontacargas'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UsoBateriasMontacargas'][$this->getPrimaryKey()] = true;
        $keys = UsoBateriasMontacargasPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getMc(),
            $keys[2] => $this->getBt(),
            ...
            $keys[5] => $this->getUsuarioEntrada(),
            $keys[6] => $this->getUsuarioSalida(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setUsuarioEntrada($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setUsuarioSalida($arr[$keys[6]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::ID)) $criteria->add(UsoBateriasMontacargasPeer::ID, $this->id);
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::MC)) $criteria->add(UsoBateriasMontacargasPeer::MC, $this->mc);
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::BT)) $criteria->add(UsoBateriasMontacargasPeer::BT, $this->bt);
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::FECHA_ENTRADA)) $criteria->add(UsoBateriasMontacargasPeer::FECHA_ENTRADA, $this->fecha_entrada);
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::FECHA_SALIDA)) $criteria->add(UsoBateriasMontacargasPeer::FECHA_SALIDA, $this->fecha_salida);
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::USUARIO_ENTRADA)) $criteria->add(UsoBateriasMontacargasPeer::USUARIO_ENTRADA, $this->usuario_entrada);
        if ($this->isColumnModified(UsoBateriasMontacargasPeer::USUARIO_SALIDA)) $criteria->add(UsoBateriasMontacargasPeer::USUARIO_SALIDA, $this->usuario_salida);
    ...
    {
        $criteria = new Criteria(UsoBateriasMontacargasPeer::DATABASE_NAME);
        $criteria->add(UsoBateriasMontacargasPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UsoBateriasMontacargas (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UsoBateriasMontacargas Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UsoBateriasMontacargasPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UsoBateriasMontacargasPeer();
        }
    ...
    public function setBaterias(Baterias $v = null)
    {
        ...
        if ($v !== null) {
            $v->addUsoBateriasMontacargas($this);
        }
    ...
    public function getBaterias(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBaterias === null && ($this->bt !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBaterias->addUsoBateriasMontacargass($this);
             */
        }
    ...
    {
        if ($this->aMontacargas === null && ($this->mc !== null) && $doQuery) {
            $this->aMontacargas = MontacargasQuery::create()->findPk($this->mc, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMontacargas->addUsoBateriasMontacargass($this);
             */
        }
    ...
    public function setUcUsersRelatedByUsuarioEntrada(UcUsers $v = null)
    {
        ...
        if ($v !== null) {
            $v->addUsoBateriasMontacargasRelatedByUsuarioEntrada($this);
        }
    ...
    public function getUcUsersRelatedByUsuarioEntrada(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUcUsersRelatedByUsuarioEntrada === null && ($this->usuario_entrada !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUcUsersRelatedByUsuarioEntrada->addUsoBateriasMontacargassRelatedByUsuarioEntrada($this);
             */
        }
    ...
    public function setUcUsersRelatedByUsuarioSalida(UcUsers $v = null)
    {
        ...
        // If this object has already been added to the UcUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addUsoBateriasMontacargasRelatedByUsuarioSalida($this);
        }
    ...
    public function getUcUsersRelatedByUsuarioSalida(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUcUsersRelatedByUsuarioSalida === null && ($this->usuario_salida !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUcUsersRelatedByUsuarioSalida->addUsoBateriasMontacargassRelatedByUsuarioSalida($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UsoBateriasMontacargasPeer::DEFAULT_STRING_FORMAT);
    }
