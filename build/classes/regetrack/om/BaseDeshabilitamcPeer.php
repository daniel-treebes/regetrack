...
abstract class BaseDeshabilitamcPeer
{
    ...
    const IDMONTACARGAS = 'deshabilitamc.idmontacargas';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Idmontacargas', 'Motivo', 'FechaEntrada', 'FechaSalida', 'UsuarioEntrada', 'UsuarioSalida', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idmontacargas', 'motivo', 'fechaEntrada', 'fechaSalida', 'usuarioEntrada', 'usuarioSalida', ),
        BasePeer::TYPE_COLNAME => array (DeshabilitamcPeer::ID, DeshabilitamcPeer::IDMONTACARGAS, DeshabilitamcPeer::MOTIVO, DeshabilitamcPeer::FECHA_ENTRADA, DeshabilitamcPeer::FECHA_SALIDA, DeshabilitamcPeer::USUARIO_ENTRADA, DeshabilitamcPeer::USUARIO_SALIDA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IDMONTACARGAS', 'MOTIVO', 'FECHA_ENTRADA', 'FECHA_SALIDA', 'USUARIO_ENTRADA', 'USUARIO_SALIDA', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'idmontacargas', 'motivo', 'fecha_entrada', 'fecha_salida', 'usuario_entrada', 'usuario_salida', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Idmontacargas' => 1, 'Motivo' => 2, 'FechaEntrada' => 3, 'FechaSalida' => 4, 'UsuarioEntrada' => 5, 'UsuarioSalida' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idmontacargas' => 1, 'motivo' => 2, 'fechaEntrada' => 3, 'fechaSalida' => 4, 'usuarioEntrada' => 5, 'usuarioSalida' => 6, ),
        BasePeer::TYPE_COLNAME => array (DeshabilitamcPeer::ID => 0, DeshabilitamcPeer::IDMONTACARGAS => 1, DeshabilitamcPeer::MOTIVO => 2, DeshabilitamcPeer::FECHA_ENTRADA => 3, DeshabilitamcPeer::FECHA_SALIDA => 4, DeshabilitamcPeer::USUARIO_ENTRADA => 5, DeshabilitamcPeer::USUARIO_SALIDA => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IDMONTACARGAS' => 1, 'MOTIVO' => 2, 'FECHA_ENTRADA' => 3, 'FECHA_SALIDA' => 4, 'USUARIO_ENTRADA' => 5, 'USUARIO_SALIDA' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'idmontacargas' => 1, 'motivo' => 2, 'fecha_entrada' => 3, 'fecha_salida' => 4, 'usuario_entrada' => 5, 'usuario_salida' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DeshabilitamcPeer::IDMONTACARGAS);
    ...
    public static function doCountJoinMontacargas(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(DeshabilitamcPeer::IDMONTACARGAS, MontacargasPeer::IDMONTACARGAS, $join_behavior);
    ...
    public static function doCountJoinUcUsersRelatedByUsuarioEntrada(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(DeshabilitamcPeer::USUARIO_ENTRADA, UcUsersPeer::ID, $join_behavior);
    ...
    public static function doCountJoinUcUsersRelatedByUsuarioSalida(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(DeshabilitamcPeer::USUARIO_SALIDA, UcUsersPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Deshabilitamc objects pre-filled with their Montacargas objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Deshabilitamc objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinMontacargas(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        DeshabilitamcPeer::addSelectColumns($criteria);
        $startcol = DeshabilitamcPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = DeshabilitamcPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = DeshabilitamcPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                DeshabilitamcPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Deshabilitamc) to $obj2 (Montacargas)
                $obj2->addDeshabilitamc($obj1);
    ...
    /**
     * Selects a collection of Deshabilitamc objects pre-filled with their UcUsers objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Deshabilitamc objects.
    ...
    public static function doSelectJoinUcUsersRelatedByUsuarioEntrada(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Deshabilitamc) to $obj2 (UcUsers)
                $obj2->addDeshabilitamcRelatedByUsuarioEntrada($obj1);
    ...
    public static function doSelectJoinUcUsersRelatedByUsuarioSalida(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Deshabilitamc) to $obj2 (UcUsers)
                $obj2->addDeshabilitamcRelatedByUsuarioSalida($obj1);
    ...
    /**
     * Selects a collection of Deshabilitamc objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        DeshabilitamcPeer::addSelectColumns($criteria);
        $startcol2 = DeshabilitamcPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Deshabilitamc) to the collection in $obj2 (Montacargas)
                $obj2->addDeshabilitamc($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Deshabilitamc) to the collection in $obj3 (UcUsers)
                $obj3->addDeshabilitamcRelatedByUsuarioEntrada($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Deshabilitamc) to the collection in $obj4 (UcUsers)
                $obj4->addDeshabilitamcRelatedByUsuarioSalida($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Deshabilitamc objects pre-filled with all related objects except Montacargas.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptMontacargas(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = DeshabilitamcPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Deshabilitamc) to the collection in $obj2 (UcUsers)
                $obj2->addDeshabilitamcRelatedByUsuarioEntrada($obj1);
                ...
                // Add the $obj1 (Deshabilitamc) to the collection in $obj3 (UcUsers)
                $obj3->addDeshabilitamcRelatedByUsuarioSalida($obj1);
    ...
    /**
     * Selects a collection of Deshabilitamc objects pre-filled with all related objects except UcUsersRelatedByUsuarioEntrada.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Deshabilitamc objects pre-filled with all related objects except UcUsersRelatedByUsuarioSalida.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
