...
abstract class BaseBaterias extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the num_serie field.
     * @var        string
     */
    protected $num_serie;
    ...
    {
        $this->ciclos_mant = 120;
        $this->ciclos_iniciales = 0;
    }
    ...
    /**
     * Get the [num_serie] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BateriasPeer::ID;
        }
    ...
    public function setTipo($v)
    {
        ...
        if ($this->tipo !== $v) {
            $this->tipo = $v;
            $this->modifiedColumns[] = BateriasPeer::TIPO;
        }
    ...
    /**
     * Set the value of [num_serie] column.
     *
    ...
    public function setNumSerie($v)
    {
        ...
        if ($this->num_serie !== $v) {
            $this->num_serie = $v;
            $this->modifiedColumns[] = BateriasPeer::NUM_SERIE;
        }
    ...
    public function setCiclosMant($v)
    {
        ...
        if ($this->ciclos_mant !== $v) {
            $this->ciclos_mant = $v;
            $this->modifiedColumns[] = BateriasPeer::CICLOS_MANT;
        }
    ...
    public function setCiclosIniciales($v)
    {
        ...
        if ($this->ciclos_iniciales !== $v) {
            ...
            $this->modifiedColumns[] = BateriasPeer::CICLOS_INICIALES;
        }
    ...
    {
            if ($this->ciclos_mant !== 120) {
                return false;
            }

            if ($this->ciclos_iniciales !== 0) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->tipo = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->num_serie = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->ciclos_mant = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->ciclos_iniciales = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = BateriasPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BateriasPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BateriasPeer::TIPO)) {
            $modifiedColumns[':p' . $index++]  = '`tipo`';
        }
        if ($this->isColumnModified(BateriasPeer::NUM_SERIE)) {
            $modifiedColumns[':p' . $index++]  = '`num_serie`';
        }
        if ($this->isColumnModified(BateriasPeer::CICLOS_MANT)) {
            $modifiedColumns[':p' . $index++]  = '`ciclos_mant`';
        }
        if ($this->isColumnModified(BateriasPeer::CICLOS_INICIALES)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`tipo`':
                        ...
                        break;
                    case '`num_serie`':
                        $stmt->bindValue($identifier, $this->num_serie, PDO::PARAM_STR);
                        break;
                    case '`ciclos_mant`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getTipo(),
            $keys[2] => $this->getNumSerie(),
            $keys[3] => $this->getCiclosMant(),
            $keys[4] => $this->getCiclosIniciales(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setNumSerie($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCiclosMant($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setCiclosIniciales($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BateriasPeer::ID)) $criteria->add(BateriasPeer::ID, $this->id);
        if ($this->isColumnModified(BateriasPeer::TIPO)) $criteria->add(BateriasPeer::TIPO, $this->tipo);
        if ($this->isColumnModified(BateriasPeer::NUM_SERIE)) $criteria->add(BateriasPeer::NUM_SERIE, $this->num_serie);
        if ($this->isColumnModified(BateriasPeer::CICLOS_MANT)) $criteria->add(BateriasPeer::CICLOS_MANT, $this->ciclos_mant);
        if ($this->isColumnModified(BateriasPeer::CICLOS_INICIALES)) $criteria->add(BateriasPeer::CICLOS_INICIALES, $this->ciclos_iniciales);
    ...
    {
        $criteria = new Criteria(BateriasPeer::DATABASE_NAME);
        $criteria->add(BateriasPeer::ID, $this->id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNumSerie($this->getNumSerie());
