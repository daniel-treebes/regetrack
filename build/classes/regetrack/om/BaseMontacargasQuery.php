 ...
 * @method MontacargasQuery orderByMontacargasBaja($order = Criteria::ASC) Order by the montacargas_baja column
 *
 ...
 * @method MontacargasQuery groupByMontacargasBaja() Group by the montacargas_baja column
 *
 ...
 * @method Montacargas findOneByMontacargasBaja(int $montacargas_baja) Return the first Montacargas filtered by the montacargas_baja column
 *
 ...
 * @method array findByMontacargasBaja(int $montacargas_baja) Return Montacargas objects filtered by the montacargas_baja column
 *
...
abstract class BaseMontacargasQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query on the montacargas_baja column
     *
     * Example usage:
     * <code>
     * $query->filterByMontacargasBaja(1234); // WHERE montacargas_baja = 1234
     * $query->filterByMontacargasBaja(array(12, 34)); // WHERE montacargas_baja IN (12, 34)
     * $query->filterByMontacargasBaja(array('min' => 12)); // WHERE montacargas_baja >= 12
     * $query->filterByMontacargasBaja(array('max' => 12)); // WHERE montacargas_baja <= 12
     * </code>
     *
     * @param     mixed $montacargasBaja The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
