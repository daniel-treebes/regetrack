...
/**
 * Base class that represents a row from the 'deshabilitacg' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseDeshabilitacg extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DeshabilitacgPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DeshabilitacgPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DeshabilitacgPeer::ID;
        }
    ...
    /**
     * Set the value of [cg] column.
     *
     * @param  int $v new value
     * @return Deshabilitacg The current object (for fluent API support)
     */
    public function setCg($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
    ...
    public function setMotivo($v)
    {
        ...
        if ($this->motivo !== $v) {
            $this->motivo = $v;
            $this->modifiedColumns[] = DeshabilitacgPeer::MOTIVO;
        }
    ...
    public function setFechaEntrada($v)
    {
        ...
        if ($this->fecha_entrada !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeshabilitacgPeer::FECHA_ENTRADA;
            }
    ...
    public function setFechaSalida($v)
    {
        ...
        if ($this->fecha_salida !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeshabilitacgPeer::FECHA_SALIDA;
            }
        } // if either are not null
    ...
    public function setUsuarioEntrada($v)
    {
        ...
        if ($this->usuario_entrada !== $v) {
            ...
            $this->modifiedColumns[] = DeshabilitacgPeer::USUARIO_ENTRADA;
        }
    ...
    public function setUsuarioSalida($v)
    {
        ...
        if ($this->usuario_salida !== $v) {
            ...
            $this->modifiedColumns[] = DeshabilitacgPeer::USUARIO_SALIDA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cg = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 7; // 7 = DeshabilitacgPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Deshabilitacg object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DeshabilitacgPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DeshabilitacgQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DeshabilitacgPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DeshabilitacgPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DeshabilitacgPeer::CG)) {
            $modifiedColumns[':p' . $index++]  = '`cg`';
        }
        if ($this->isColumnModified(DeshabilitacgPeer::MOTIVO)) {
            $modifiedColumns[':p' . $index++]  = '`motivo`';
        }
        if ($this->isColumnModified(DeshabilitacgPeer::FECHA_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_entrada`';
        }
        if ($this->isColumnModified(DeshabilitacgPeer::FECHA_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_salida`';
        }
        if ($this->isColumnModified(DeshabilitacgPeer::USUARIO_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_entrada`';
        }
        if ($this->isColumnModified(DeshabilitacgPeer::USUARIO_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_salida`';
        }

        $sql = sprintf(
            'INSERT INTO `deshabilitacg` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`cg`':
                        $stmt->bindValue($identifier, $this->cg, PDO::PARAM_INT);
                        break;
                    case '`motivo`':
    ...
    {
        $pos = DeshabilitacgPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Deshabilitacg'][$this->getPrimaryKey()] = true;
        $keys = DeshabilitacgPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCg(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setCg($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DeshabilitacgPeer::ID)) $criteria->add(DeshabilitacgPeer::ID, $this->id);
        if ($this->isColumnModified(DeshabilitacgPeer::CG)) $criteria->add(DeshabilitacgPeer::CG, $this->cg);
        if ($this->isColumnModified(DeshabilitacgPeer::MOTIVO)) $criteria->add(DeshabilitacgPeer::MOTIVO, $this->motivo);
        if ($this->isColumnModified(DeshabilitacgPeer::FECHA_ENTRADA)) $criteria->add(DeshabilitacgPeer::FECHA_ENTRADA, $this->fecha_entrada);
        if ($this->isColumnModified(DeshabilitacgPeer::FECHA_SALIDA)) $criteria->add(DeshabilitacgPeer::FECHA_SALIDA, $this->fecha_salida);
        if ($this->isColumnModified(DeshabilitacgPeer::USUARIO_ENTRADA)) $criteria->add(DeshabilitacgPeer::USUARIO_ENTRADA, $this->usuario_entrada);
        if ($this->isColumnModified(DeshabilitacgPeer::USUARIO_SALIDA)) $criteria->add(DeshabilitacgPeer::USUARIO_SALIDA, $this->usuario_salida);
    ...
    {
        $criteria = new Criteria(DeshabilitacgPeer::DATABASE_NAME);
        $criteria->add(DeshabilitacgPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Deshabilitacg (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Deshabilitacg Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DeshabilitacgPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DeshabilitacgPeer();
        }
    ...
    {
        return (string) $this->exportTo(DeshabilitacgPeer::DEFAULT_STRING_FORMAT);
    }
