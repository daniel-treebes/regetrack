...
abstract class BaseSucursalPeer
{
    ...
    /** the column name for the sucursal_suscripcioninicio field */
    const SUCURSAL_SUSCRIPCIONINICIO = 'sucursal.sucursal_suscripcioninicio';

    /** the column name for the sucursal_suscripcionfin field */
    const SUCURSAL_SUSCRIPCIONFIN = 'sucursal.sucursal_suscripcionfin';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idsucursal', 'Idempresa', 'SucursalNombre', 'SucursalSuscripcioninicio', 'SucursalSuscripcionfin', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idsucursal', 'idempresa', 'sucursalNombre', 'sucursalSuscripcioninicio', 'sucursalSuscripcionfin', ),
        BasePeer::TYPE_COLNAME => array (SucursalPeer::IDSUCURSAL, SucursalPeer::IDEMPRESA, SucursalPeer::SUCURSAL_NOMBRE, SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO, SucursalPeer::SUCURSAL_SUSCRIPCIONFIN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDSUCURSAL', 'IDEMPRESA', 'SUCURSAL_NOMBRE', 'SUCURSAL_SUSCRIPCIONINICIO', 'SUCURSAL_SUSCRIPCIONFIN', ),
        BasePeer::TYPE_FIELDNAME => array ('idsucursal', 'idempresa', 'sucursal_nombre', 'sucursal_suscripcioninicio', 'sucursal_suscripcionfin', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idsucursal' => 0, 'Idempresa' => 1, 'SucursalNombre' => 2, 'SucursalSuscripcioninicio' => 3, 'SucursalSuscripcionfin' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idsucursal' => 0, 'idempresa' => 1, 'sucursalNombre' => 2, 'sucursalSuscripcioninicio' => 3, 'sucursalSuscripcionfin' => 4, ),
        BasePeer::TYPE_COLNAME => array (SucursalPeer::IDSUCURSAL => 0, SucursalPeer::IDEMPRESA => 1, SucursalPeer::SUCURSAL_NOMBRE => 2, SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO => 3, SucursalPeer::SUCURSAL_SUSCRIPCIONFIN => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDSUCURSAL' => 0, 'IDEMPRESA' => 1, 'SUCURSAL_NOMBRE' => 2, 'SUCURSAL_SUSCRIPCIONINICIO' => 3, 'SUCURSAL_SUSCRIPCIONFIN' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('idsucursal' => 0, 'idempresa' => 1, 'sucursal_nombre' => 2, 'sucursal_suscripcioninicio' => 3, 'sucursal_suscripcionfin' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_SUSCRIPCIONINICIO);
            $criteria->addSelectColumn(SucursalPeer::SUCURSAL_SUSCRIPCIONFIN);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.sucursal_suscripcioninicio');
            $criteria->addSelectColumn($alias . '.sucursal_suscripcionfin');
        }
    }
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in UcUsersPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(BateriasPeer::IDSUCURSAL, $obj->getIdsucursal());
            ...
            $criteria->add(CargadoresPeer::IDSUCURSAL, $obj->getIdsucursal());
            ...
            $criteria->add(MontacargasPeer::IDSUCURSAL, $obj->getIdsucursal());
            $affectedRows += MontacargasPeer::doDelete($criteria, $con);

            // delete related UcUsers objects
            $criteria = new Criteria(UcUsersPeer::DATABASE_NAME);

            $criteria->add(UcUsersPeer::IDSUCURSAL, $obj->getIdsucursal());
            $affectedRows += UcUsersPeer::doDelete($criteria, $con);
        }
