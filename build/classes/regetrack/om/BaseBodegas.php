...
/**
 * Base class that represents a row from the 'bodegas' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseBodegas extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'BodegasPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BodegasPeer::ID;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[] = BodegasPeer::NOMBRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cg = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = BodegasPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Bodegas object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BodegasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BodegasQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BodegasPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BodegasPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BodegasPeer::NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`nombre`';
        }
        if ($this->isColumnModified(BodegasPeer::CG)) {
            $modifiedColumns[':p' . $index++]  = '`cg`';
        }

        $sql = sprintf(
            'INSERT INTO `bodegas` (%s) VALUES (%s)',
    ...
    {
        $pos = BodegasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Bodegas'][$this->getPrimaryKey()] = true;
        $keys = BodegasPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCg($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BodegasPeer::ID)) $criteria->add(BodegasPeer::ID, $this->id);
        if ($this->isColumnModified(BodegasPeer::NOMBRE)) $criteria->add(BodegasPeer::NOMBRE, $this->nombre);
        if ($this->isColumnModified(BodegasPeer::CG)) $criteria->add(BodegasPeer::CG, $this->cg);
    ...
    {
        $criteria = new Criteria(BodegasPeer::DATABASE_NAME);
        $criteria->add(BodegasPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Bodegas (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Bodegas Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(BodegasPeer::DEFAULT_STRING_FORMAT);
    }
