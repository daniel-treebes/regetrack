...
/**
 * Base class that represents a row from the 'deshabilitamc' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseDeshabilitamc extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DeshabilitamcPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DeshabilitamcPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DeshabilitamcPeer::ID;
        }
    ...
    public function setMotivo($v)
    {
        ...
        if ($this->motivo !== $v) {
            $this->motivo = $v;
            $this->modifiedColumns[] = DeshabilitamcPeer::MOTIVO;
        }
    ...
    public function setFechaEntrada($v)
    {
        ...
        if ($this->fecha_entrada !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeshabilitamcPeer::FECHA_ENTRADA;
            }
    ...
    public function setFechaSalida($v)
    {
        ...
        if ($this->fecha_salida !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeshabilitamcPeer::FECHA_SALIDA;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = DeshabilitamcPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Deshabilitamc object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DeshabilitamcPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DeshabilitamcQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DeshabilitamcPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DeshabilitamcPeer::FECHA_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_entrada`';
        }
        if ($this->isColumnModified(DeshabilitamcPeer::FECHA_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_salida`';
        }
        if ($this->isColumnModified(DeshabilitamcPeer::USUARIO_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_entrada`';
        }
        if ($this->isColumnModified(DeshabilitamcPeer::USUARIO_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_salida`';
        }

        $sql = sprintf(
            'INSERT INTO `deshabilitamc` (%s) VALUES (%s)',
    ...
    {
        $pos = DeshabilitamcPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $alreadyDumpedObjects['Deshabilitamc'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DeshabilitamcPeer::USUARIO_ENTRADA)) $criteria->add(DeshabilitamcPeer::USUARIO_ENTRADA, $this->usuario_entrada);
        if ($this->isColumnModified(DeshabilitamcPeer::USUARIO_SALIDA)) $criteria->add(DeshabilitamcPeer::USUARIO_SALIDA, $this->usuario_salida);
    ...
    {
        $criteria = new Criteria(DeshabilitamcPeer::DATABASE_NAME);
        $criteria->add(DeshabilitamcPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Deshabilitamc (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Deshabilitamc Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DeshabilitamcPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DeshabilitamcPeer();
        }
    ...
    {
        return (string) $this->exportTo(DeshabilitamcPeer::DEFAULT_STRING_FORMAT);
    }
