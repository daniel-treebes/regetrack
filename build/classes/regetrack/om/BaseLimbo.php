...
/**
 * Base class that represents a row from the 'limbo' table.
 *
 *
 *
 * @package    propel.generator.regetrack.om
 */
abstract class BaseLimbo extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LimboPeer';
     ...
     * @return Limbo The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LimboPeer::ID;
        }
    ...
    public function setBt($v)
    {
        ...
        if ($this->bt !== $v) {
            $this->bt = $v;
            $this->modifiedColumns[] = LimboPeer::BT;
        }
    ...
    public function setMotivo($v)
    {
        ...
        if ($this->motivo !== $v) {
            $this->motivo = $v;
            $this->modifiedColumns[] = LimboPeer::MOTIVO;
        }
    ...
    public function setFechaEntrada($v)
    {
        ...
        if ($this->fecha_entrada !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LimboPeer::FECHA_ENTRADA;
            }
    ...
    public function setFechaSalida($v)
    {
        ...
        if ($this->fecha_salida !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LimboPeer::FECHA_SALIDA;
            }
        } // if either are not null
    ...
    public function setUsuarioEntrada($v)
    {
        ...
        if ($this->usuario_entrada !== $v) {
            ...
            $this->modifiedColumns[] = LimboPeer::USUARIO_ENTRADA;
        }
    ...
    public function setUsuarioSalida($v)
    {
        ...
        if ($this->usuario_salida !== $v) {
            ...
            $this->modifiedColumns[] = LimboPeer::USUARIO_SALIDA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = LimboPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Limbo object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LimboPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LimboPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LimboPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LimboPeer::BT)) {
            $modifiedColumns[':p' . $index++]  = '`bt`';
        }
        if ($this->isColumnModified(LimboPeer::MOTIVO)) {
            $modifiedColumns[':p' . $index++]  = '`motivo`';
        }
        if ($this->isColumnModified(LimboPeer::FECHA_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_entrada`';
        }
        if ($this->isColumnModified(LimboPeer::FECHA_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_salida`';
        }
        if ($this->isColumnModified(LimboPeer::USUARIO_ENTRADA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_entrada`';
        }
        if ($this->isColumnModified(LimboPeer::USUARIO_SALIDA)) {
            $modifiedColumns[':p' . $index++]  = '`usuario_salida`';
        }

        $sql = sprintf(
            'INSERT INTO `limbo` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LimboPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LimboPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Limbo'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Limbo'][$this->getPrimaryKey()] = true;
        $keys = LimboPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getBt(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LimboPeer::ID)) $criteria->add(LimboPeer::ID, $this->id);
        if ($this->isColumnModified(LimboPeer::BT)) $criteria->add(LimboPeer::BT, $this->bt);
        if ($this->isColumnModified(LimboPeer::MOTIVO)) $criteria->add(LimboPeer::MOTIVO, $this->motivo);
        if ($this->isColumnModified(LimboPeer::FECHA_ENTRADA)) $criteria->add(LimboPeer::FECHA_ENTRADA, $this->fecha_entrada);
        if ($this->isColumnModified(LimboPeer::FECHA_SALIDA)) $criteria->add(LimboPeer::FECHA_SALIDA, $this->fecha_salida);
        if ($this->isColumnModified(LimboPeer::USUARIO_ENTRADA)) $criteria->add(LimboPeer::USUARIO_ENTRADA, $this->usuario_entrada);
        if ($this->isColumnModified(LimboPeer::USUARIO_SALIDA)) $criteria->add(LimboPeer::USUARIO_SALIDA, $this->usuario_salida);
    ...
    {
        $criteria = new Criteria(LimboPeer::DATABASE_NAME);
        $criteria->add(LimboPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Limbo (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Limbo Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(LimboPeer::DEFAULT_STRING_FORMAT);
    }
