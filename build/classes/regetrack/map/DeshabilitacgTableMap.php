...
/**
 * This class defines the structure of the 'deshabilitacg' table.
 *
 *
 *
 ...
 */
class DeshabilitacgTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'regetrack.map.DeshabilitacgTableMap';
    ...
    {
        // attributes
        $this->setName('deshabilitacg');
        $this->setPhpName('Deshabilitacg');
        $this->setClassname('Deshabilitacg');
