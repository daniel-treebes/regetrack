                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="mt-checkbox-list">
                                            ...
                                            <input value="<?php echo $modelo['tipo']?>" name="baterias[]" type="checkbox" style="display: inline-block">
                                            <label style="display: inline-block" class="mt-checkbox mt-checkbox-inline"> <?php echo $modelo['tipo']?>
