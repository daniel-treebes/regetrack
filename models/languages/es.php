...
$lang = array_merge($lang,array(
	"ACCOUNT_SPECIFY_USERNAME" 		=> "Ingresa tu usuario",
	"ACCOUNT_SPECIFY_PASSWORD" 		=> "Ingresa tu password",
	"ACCOUNT_SPECIFY_EMAIL"			=> "Ingresa tu email",
	"ACCOUNT_INVALID_EMAIL"			=> "Email inválido",
	"ACCOUNT_USER_OR_EMAIL_INVALID"		=> "Usuario o contraseña inválidas",
	"ACCOUNT_USER_OR_PASS_INVALID"		=> "Usuario o contraseña inválidas",
	"ACCOUNT_ALREADY_ACTIVE"		=> "Tu cuenta esta activa.",
	"ACCOUNT_INACTIVE"			=> "Tu cuenta a sido desactivada.",
