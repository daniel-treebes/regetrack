...
define('PHPGRID_DB_USERNAME', 'regetrac_phpgrid');     // database user name
define('PHPGRID_DB_PASSWORD', '?82yLT3!4!9F'); // database password
define('PHPGRID_DB_NAME', 'regetrac_phpgrid'); // database name
