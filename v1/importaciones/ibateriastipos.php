...
REPLACE INTO TABLE bateriastipos 
CHARACTER SET utf8 
FIELDS TERMINATED BY ',' 
OPTIONALLY ENCLOSED BY '\"' 
ESCAPED BY '\"' 
IGNORE 1 LINES
(id, nombre, marca, celdas, factor_k, placas, volts, ah, vida_util,regeneracion_preventiva, regeneracion_correctiva)
";
...
echo "Tipos de bateria actualizados";
