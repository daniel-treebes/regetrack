...
$nombrePagina="Montacargas - Edicion";
$acciones=[];
$acciones[0][0]="Nuevo";
	...
	<table id="example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
        ...
        <tbody>
			 ...
			 while($fila = $resultado->fetch_array()) {
				...
				echo "<th>".$fila['Proximo Cambio']."</th>";
				echo "<th>".$fila['Salud de baterias']."</th>";
				$herramientas="<button type='button' class='btn green' onclick='window.location.href=\"edita/montacargas.php&id=".$fila['Id']."\"'><i class='fa fa-cogs'></i>Herramientas</button>"
				$herramientas.="<button type='button' class='btn red' onclick='window.location.href=\"edita/montacargas.php&id=".$fila['Id']."\"'><i class='fa fa-trash'></i> Editar</button>";
